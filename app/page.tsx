      ...
      {user ? (
        <>
          <div className="flex items-center w-full p-2 mb-4 justify-between">
            <p className='flex-grow-2 basis-2/3'><strong className='text-green-600'>{user.username}</strong>님</p>
        ...
        <>
          <div className="flex flex-col items-center justify-center text-center mb-8">
            ...
            <div className="flex gap-4 font-bold">
              <Link href="/login" className="text-green-500 hover:underline">로그인</Link>
              <Link href="/signup" className="text-green-500 hover:underline">회원가입</Link>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col items-center bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">매일의 생각과 경험을 기록하고 저장하기</p>
            </div>
            <div className="flex flex-col items-center bg-white p-6 rounded-lg shadow-md">
              <FiCheckCircle className="text-green-600 text-4xl mb-4" />
              <h2 className="text-2xl font-bold mb-2">생각 정리</h2>
              <p className="text-gray-600">과거의 일기를 쉽게 검색하고 추억 돌아보기</p>
            </div>
            <div className="flex flex-col items-center bg-white p-6 rounded-lg shadow-md">
              <FiCheckCircle className="text-green-600 text-4xl mb-4" />
              <h2 className="text-2xl font-bold mb-2">꾸준함 유지</h2>
              <p className="text-gray-600">매일 일기를 작성하는 습관을 들이기</p>
            </div>
          </div>
        </>
      )}
